...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        "label-xs": ["10px", { lineHeight: "1.4", fontWeight: "600" }],
        "label-sm": ["13px", { lineHeight: "1.4", fontWeight: "600" }],
        "body-sm": ["13px", { lineHeight: "1.4" }],
        "body-xs": ["11px", { lineHeight: "1.4" }],
        "body-base": ["15px", { lineHeight: "1.5" }],
        "body-md": ["14px", { lineHeight: "1.5" }],
        "heading-sm": ["24px", { lineHeight: "1.25", fontWeight: "700" }],
        "heading-lg": ["28px", { lineHeight: "1.25", fontWeight: "700" }],
      },
      colors: {
        border: "var(--border)",
        input: "var(--border)",
